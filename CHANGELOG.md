...
- Added `AGENTS.md` with development rules: CI credit conservation, branching strategy, pre-commit checks, MSRV policy, changelog rules
- Added `CHANGELOG.md` with retroactive entries for all prior releases
